...
| M43-PRD-016 独立全屏 Shell 与原导航隔离 | `TeacherRoutes.tsx` 将 MVP Route 移出 `AppShell`；`ClassMvpWorkBuddyShell.tsx` 独立投影品牌、能力与返回 | E2E 断言无“老师视角主导航”、`WorkBuddy 导航` 可操作；双视口视觉 |
