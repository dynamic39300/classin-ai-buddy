...
export const WORKBUDDY_COURSEWARE_OUTPUT: CoursewareExecutionOutput = Object.freeze({
  events: Object.freeze([
    Object.freeze({ id: 'event-context', title: 'ContextSnapshot 已载入', summary: '冻结的教学范围与资源引用已校验。', state: 'completed' }),
    ...
    Object.freeze({ id: 'event-draft', title: '课件草稿已组装', summary: '固定 Mock 课件页面与讲解结构已形成。', capability: 'courseware-renderer', state: 'completed' }),
  ...
  artifact: Object.freeze({
    ...
    validationSummary: '教学目标、内容结构、术语与课堂练习覆盖检查通过', truthLabel: '固定 Mock ArtifactDraft · 未写入 ClassIn',
  }),
});
