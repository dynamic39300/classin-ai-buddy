...
export type WorkBuddyCapability = {
  id: 'agentin' | 'skills' | 'tools' | 'content' | 'files' | 'schedules' | 'settings';
  label: string;
  description: string;
  icon: LucideIcon;
...
export const WORKBUDDY_CAPABILITIES: readonly WorkBuddyCapability[] = [
  { id: 'agentin', label: 'AgentIn', description: '发现可添加到 ClassIn 教学场景的智能体。', icon: Bot, placement: 'resource', availability: 'active' },
  ...
  { id: 'files', label: '我的文件', description: '回溯 TeacherIn 在 ClassIn Space 中保存的 AI 协作产物。', icon: FolderOpen, placement: 'resource', availability: 'active' },
