...
const SKILLS: readonly CapabilityItem[] = Object.freeze([
  { id: 'standalone-skill-courseware', truth: '[模拟]', title: '智能课件结构设计', subtitle: '把教学目标组织为可讲授的页面结构', status: '已启用', statusTone: 'success', meta: ['官方能力', '适用：课件生成'], tags: ['课程生产', '结构设计'], description: '根据教师提供的范围和课堂时长生成可审阅的智能课件结构。', source: 'WorkBuddy', version: 'v1.4.0', permissions: ['读取当前任务输入', '写入个人 Artifact 草稿'] },
  { id: 'standalone-skill-goal', truth: '[模拟]', title: '教学目标澄清', subtitle: '识别目标、范围与交付物之间的缺口', status: '已安装', statusTone: 'neutral', meta: ['官方能力', '适用：所有任务'], tags: ['目标', '上下文'], description: '在执行前把教师目标转换为可确认的任务计划。', source: 'WorkBuddy', version: 'v1.2.1', permissions: ['读取当前任务上下文'] },
...
const TOOLS: readonly CapabilityItem[] = Object.freeze([
  { id: 'standalone-tool-generation', truth: '[模拟]', title: 'WorkBuddy 内容生成', subtitle: '独立产品内置能力', status: '已连接', statusTone: 'success', meta: ['http', '由独立产品托管'], tags: ['内置工具', '内容生成'], description: '提供文字转语音、AI 生图和网页资料检索能力。', source: 'WorkBuddy', permissions: ['仅访问当前任务授权的数据'] },
  { id: 'standalone-tool-file-parser', truth: '[模拟]', title: '个人文件解析', subtitle: '解析当前账号主动上传的资料', status: '已连接', statusTone: 'success', meta: ['http', '个人工作区'], tags: ['文件', '解析'], description: '提取 PDF、DOCX 与 PPTX 的文本结构，作为当前任务输入。', source: 'WorkBuddy', permissions: ['仅访问个人文件库中明确选择的文件'] },
