...
describe('WorkBuddyExperienceProfileModule', () => {
  it('projects the standalone teacher experience onto its own route and data namespace', () => {
    ...
    expect(standalone.navigationCapabilityIds).toEqual(standalone.visibleCapabilityIds);
  ...
  it('projects the ideal and MVP experiences onto different routes and data namespaces', () => {
    ...
    expect(ideal.visibleCapabilityIds).toEqual(['agentin', 'skills', 'tools', 'content', 'files', 'schedules']);
    expect(ideal.navigationCapabilityIds).toEqual(['skills', 'agentin', 'files']);
    expect(ideal.visibleCapabilityIds).toContain('tools');
    expect(ideal.visibleCapabilityIds).toContain('schedules');
    ...
    expect(mvp.visibleCapabilityIds).toEqual(ideal.visibleCapabilityIds);
    ...
    expect(workBuddyCapabilityPath(ideal, 'agentin')).toBe('/teacher/ai-agent/agentin');
