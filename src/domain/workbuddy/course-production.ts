...
export function createSingleCoursewareRun(
  definition: CoursewareRunDefinition,
  goal: string,
  contextSnapshotId: string,
  taskAssemblySnapshotId: string | null = null,
): SingleCoursewareRun {
  return freezeRun({
    fixtureVersion: definition.fixtureVersion, id: definition.id, taskType: 'single-courseware', title: definition.title,
    goal: goal.trim(), contextSnapshotId, taskAssemblySnapshotId, stage: 'needs_information', brief: definition.initialBrief, plan: definition.plan,
