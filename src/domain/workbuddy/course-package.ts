...
export function createCoursePackageRun(
  ...
  const common = { id: definition.id, fixtureVersion: definition.fixtureVersion, taskType: 'course-package' as const, title: definition.title, goal: goal.trim(), taskAssemblySnapshotId, artifacts, ...links };
