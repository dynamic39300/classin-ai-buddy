#!/usr/bin/env python3
"""Round 0 exploratory analysis of ClassIn IM chat samples.
...
The taxonomy, episode proxy, and metrics in this script are archived exploratory
methods, not decision-grade ground truth. See tools/analysis/README.md before use.
"""
